...
begin
 ...
 l := l + k;
  ...
  textout(10, 10, 'Найти площади фигуры, ограниченной кривой 1*x^3+(1)*x^2-(5)*x+(11) и осью Ох (в положительной части по оси Оу)');
...
begin
  var f2: real;
 f2 := 1/4 / 4) + 1 / 3 * power(x, 3) - 5 / 2 * power(x, 2) + 11 * x;
 func1 := f2;
end;
